...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_ACCELERATED_PAINTING PUBLIC OFF)
...
# DirectFB support
WEBKIT_OPTION_DEFINE(ENABLE_DIRECTFB "Whether to enable DirectFB." PUBLIC ON)
...
if (ENABLE_OPENGL)
    ...
    # Enable Cairo AC
    SET_AND_EXPOSE_TO_BUILD(USE_TEXTURE_MAPPER_CAIRO TRUE)
    SET_AND_EXPOSE_TO_BUILD(USE_LIBEPOXY FALSE)
endif()

if (ENABLE_DIRECTFB)
    find_package(DirectFB)
    if (NOT DIRECTFB_FOUND)
        message(FATAL_ERROR "DirectFB Package is needed for ENABLE_DIRECTFB.")
    endif ()
    SET_AND_EXPOSE_TO_BUILD(USE_DIRECTFB TRUE)
endif()

if (ENABLE_ACCELERATED_PAINTING)
    if (NOT ENABLE_DIRECTFB)
        message(FATAL_ERROR "DirectFB must be enabled for ENABLE_ACCELERATED_PAINTING")
    endif ()
    find_package(CairoDirectFB 0.0.1 REQUIRED COMPONENTS cairo-directfb)
endif ()
